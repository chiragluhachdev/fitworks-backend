  ...
  try {
    ...
    const trainer2 = await Trainer.create({
      ...
      workPreferences: {
        ...
        preferredLocations: ["Delhi NCR", "Bangalore"],
        availability: "Immediate",
        willingToRelocate: true,
      },
      verificationStatus: "verified",
      verificationDocuments: ["https://example.com/cert2.pdf"],
    });
    ...
    const trainer3 = await Trainer.create({
      ...
      professional: {
        professionalTitle: "Bodybuilding & Hypertrophy Coach",
        yearsOfExperience: 4,
        specializations: ["Strength", "Bodybuilding", "Nutrition"],
        skills: ["Hypertrophy Programming", "Nutritional Periodization", "Form Correction"],
        certifications: [{ name: "K11 Certified Personal Trainer" }],
        education: "Certified Fitness Trainer",
        bio: "Specializing in muscle hypertrophy, athletic conditioning, and fat loss transformations.",
      },
      workPreferences: {
        expectedMonthlySalary: "32,000",
        employmentType: ["Full-time"],
